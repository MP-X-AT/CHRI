...
export const deContent: ExtendedSiteContent = {
  ...
  "home": {
    ...
    "servicesPreview": {
      ...
      "intro": "Ein ruhiger Rahmen für persönliche, berufliche und soziale Fragestellungen.",
      "items": [
        {
          "title": "Psychotherapie",
  ...
  "angebot": {
    ...
    "intro": "Ich biete geschlechtersensible Psychotherapie, Beratung, Supervision und Coaching unter anderem bei folgenden Themen und Belastungen an.",
    "items": [
      {
        "id": "life-crises",
        "label": "Lebenskrisen"
    ...
    "panels": [
      ...
      },
      {
        ...
        "title": "Wenn Zusammenarbeit, Beziehungen oder Rollenfragen Raum brauchen.",
  ...
  "arbeitsweise": {
    ...
    "psychodramaQuote": "„Psychodrama ist die Methode, welche die Wahrheit der Seele durch Handeln ergründet.“",
    "psychodramaAuthor": "J. L. Moreno",
    "psychodramaTitle": "Psychodrama",
    "psychodramaText": "Meiner psychotherapeutischen Ausbildung liegt das Psychodrama zugrunde, eine nach dem österreichischen Psychotherapiegesetz anerkannte Therapiemethode. Ausgehend von der Rollentheorie wurde das Psychodrama bereits in den 1930er Jahren vom Arzt und Philosophen Jakob Levy Moreno entwickelt.",
    "psychodramaDetails": [
  ...
  "publikationen": {
    ...
    "items": [
      {
        ...
        "summary": "Die Publikation zeigt, wie über eine Körperbeziehungsübung ein sensibler Zugang zu körperbezogenen Themen eröffnet werden kann. Im Mittelpunkt stehen Wahrnehmung, Beziehung zum eigenen Körper und die psychodramatische Arbeit mit Mädchen und Frauen im Einzel- und Gruppensetting.",
        "tags": [
          "Körperarbeit",
          "Psychodrama",
          "Beziehung",
      ...
      },
      {
        ...
        "summary": "Der Beitrag beleuchtet, wie virtuelles Soziodrama in einer Phase gesellschaftlicher Unsicherheit kollektive Kreativität und Resilienz stärken kann. Im Fokus stehen Übergangserfahrungen während der Pandemie sowie das gemeinsame Bearbeiten sozialer und emotionaler Belastungen.",
        "tags": [
          "Soziodrama",
          "Covid-19",
          "Resilienz",
      ...
      },
      {
        ...
        "summary": "Dieser Beitrag widmet sich der Frage, welche interkulturellen Kompetenzen in der psychotherapeutischen und psychosozialen Arbeit mit traumatisierten Menschen mit Fluchterfahrung erforderlich sind. Im Zentrum stehen Sensibilität für Lebensrealitäten, Kontextwissen und tragfähige Beziehungsgestaltung.",
        "tags": [
          "Trauma",
          "Flucht",
          "Interkulturalität",
      ...
      {
        "title": "Wann bin ich richtig? Prävention von Essstörungen. Wann bin ich angemessen?",
        "subtitle": "Zeitschrift für Psychodrama und Soziometrie · 2018",
        "year": "2018",
        "href": "https://link.springer.com/article/10.1007/s11620-018-0464-7",
        "summary": "Die Publikation thematisiert Prävention von Essstörungen im Spannungsfeld von Selbstbild, Körperwahrnehmung und gesellschaftlichen Normen. Sie öffnet einen Reflexionsraum für die Frage, wann Jugendliche sich als richtig, passend oder angemessen erleben.",
        "tags": [
          "Essstörungen",
          "Prävention",
          "Jugendliche",
      ...
      },
      {
        ...
        "subtitle": "Entwicklung der Geschlechterrolle im Jugendalter · Zeitschrift für Psychodrama und Soziometrie · 2016",
        "year": "2016",
        "href": "https://link.springer.com/article/10.1007/s11620-016-0352-y?wt_mc=Internal.Event.1.SEM.ArticleAuthorAssignedToIssue",
        "summary": "Der Beitrag beschäftigt sich mit der Entwicklung von Geschlechterrollen im Jugendalter und deren Bedeutung für Identität, Selbstverständnis und soziale Orientierung. Betrachtet werden Entwicklungsprozesse im Spannungsfeld von Zugehörigkeit, Normen und individueller Entfaltung.",
        "tags": [
          "Jugend",
          "Geschlechterrollen",
          "Identität",
      ...
      },
      {
        ...
        "subtitle": "Digitale Medien, emanzipatorisches Potential und Marginalisierung · STIMME · 2019",
        "year": "2019",
        "href": "https://stimme.minderheiten.at/wordpress/wp-content/uploads/sites/3/2019/05/stimme98_web_s08-09.pdf",
        "summary": "Die Publikation reflektiert die Ambivalenz digitaler Medien zwischen emanzipatorischem Potential und neuen Formen von Marginalisierung. Sie fragt danach, wie soziale Teilhabe, Sichtbarkeit und Ausschlussmechanismen in digitalen Räumen zusammenwirken.",
        "tags": [
          "Digitale Medien",
          "Marginalisierung",
          "Teilhabe",
    ...
    "featuredInfo": "Ein kuratierter Einblick in einen fachlichen Schwerpunkt mit direktem Zugang zur Publikation.",
  ...
  "impressum": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": [
          "Diese Website enthält Links zu externen Websites Dritter, auf deren Inhalte kein Einfluss besteht. Für diese fremden Inhalte wird daher keine Gewähr übernommen. Für die Inhalte der verlinkten Seiten sind stets die jeweiligen Anbieter oder Betreiber verantwortlich."
        ]
      },
      {
        "title": "Urheberrecht",
        "body": [
          "Die durch die Seitenbetreiberin erstellten Inhalte und Werke auf dieser Website unterliegen dem Urheberrecht. Vervielfältigung, Bearbeitung, Verbreitung und jede Art der Verwertung außerhalb der Grenzen des Urheberrechts bedürfen der schriftlichen Zustimmung der jeweiligen Autorin beziehungsweise Rechteinhaberin."
        ]
      }
    ]
  },
    ...
    "sections": [
      {
        ...
        "body": [
          "Verantwortlich für die Verarbeitung personenbezogener Daten auf dieser Website ist DSAin Christine Pichlhöfer, MSc."
        ]
      },
      {
      ...
      },
      {
        ...
        "body": [
          "Wenn Sie per E-Mail oder Telefon Kontakt aufnehmen, werden Ihre Angaben zur Bearbeitung Ihrer Anfrage und für den Fall von Anschlussfragen gespeichert. Diese Daten werden nicht ohne Ihre Einwilligung weitergegeben."
        ]
      },
      {
        "title": "Server-Logfiles",
        "body": [
          "Beim Besuch dieser Website können durch den Hosting-Anbieter automatisch Informationen in sogenannten Server-Logfiles erhoben und gespeichert werden. Dies betrifft insbesondere IP-Adresse, Datum und Uhrzeit des Zugriffs, Browsertyp und Betriebssystem."
        ]
      },
      {
        "title": "Ihre Rechte",
        "body": [
          "Sie haben grundsätzlich das Recht auf Auskunft, Berichtigung, Löschung, Einschränkung, Datenübertragbarkeit, Widerruf und Widerspruch. Wenn Sie glauben, dass die Verarbeitung Ihrer Daten gegen das Datenschutzrecht verstößt, können Sie sich bei der zuständigen Aufsichtsbehörde beschweren."
        ]
      },
      {
