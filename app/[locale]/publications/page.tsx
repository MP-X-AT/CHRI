...
export default async function PublicationsPage({
  ...
  const emptyText = 'Publications will be added soon.'
  const openLabelDefault = 'Open publication'
                    ...
                    <div className="flex h-full flex-col justify-between rounded-[1.5rem] border border-black/5 bg-white/65 p-5 sm:p-6">
                      <div>
                        ...
                        <div className="mt-4 space-y-3 text-sm leading-7 text-[var(--muted-foreground)]">
                          <p>
                            A curated entry point into one of the key thematic
                            areas with direct access to the publication.
                          </p>
                        </div>
                      </div>
